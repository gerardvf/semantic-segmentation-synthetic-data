...
lr_schedule = tf.keras.optimizers.schedules.PiecewiseConstantDecay([15000, 30000], [4e-4, 2e-4, 1e-4])  # 15k update steps is around 24 epochs (cityscapes with bs 4)
opt = tf.keras.optimizers.Adam(learning_rate=lr_schedule)

weights_path = './raid_storage/weights'
