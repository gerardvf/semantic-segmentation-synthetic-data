...
loaded_weights_path = './raid_storage/weightssyn/w17.h5'
M_net.load_weights(loaded_weights_path)
print(f'Weights loaded from {loaded_weights_path}.')
...
weights_path = './raid_storage/weightsft20'
